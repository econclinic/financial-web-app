        ...
        <div className="container mx-auto px-6 py-8">
          ...
          {!loading && !error && items.length === 0 && (
            <div className="mt-8 rounded-xl border bg-muted/40 p-8 text-center text-muted-foreground">
              ...
              <p className="text-sm mt-1">Add a symbol above to start tracking.</p>
            </div>
          )}
                  ...
                  {items.map((item) => {
                    ...
                    return (
                      <tr key={item.id} className="border-b last:border-b-0">
                        ...
                        <td className={`px-4 py-3 text-right tabular-nums ${change != null && change >= 0 ? "text-green-600" : "text-red-600"}`}>
